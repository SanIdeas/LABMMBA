...
urlpatterns = [
    ...
    url(r'^gallery/upload/$', views.gallery, name="upload_gallery_photo"),
    url(r'^gallery/delete/(?P<photo_id>.*)/$', views.gallery, name="delete_gallery_photo"),
    ...
    url(r'^events/create/$', views.event_create, name="create_event"),
    url(r'^events/edit/(?P<event_id>.*)/$', views.event_edit, name="edit_event"),
    url(r'^events/delete/(?P<event_id>.*)/$', views.events, name="delete_event"),
]