...
(function() {
  ...
  ContentTools = {
    ...
    DEFAULT_TOOLS: [['bold', 'italic', 'link', 'alignleft', 'align-center', 'alignright'], ['heading', 'subheading', 'paragraph', 'unordered-list', 'ordered-list', 'table', 'indent', 'unindent', 'line-break'], ['image', 'video', 'preformatted'], ['undo', 'redo', 'remove']],
  ...
  ContentTools.Tools.Link = (function(_super) {
    ...
    Link.apply = function(element, selection, callback) {
      ...
      dialog.addEventListener('save', function(ev) {
        ...
        applied = true;
        if (element.type() === 'Image') {
          alignmentClassNames = ['align-center', 'alignleft', 'alignright'];
          if (detail.href) {
            element.a = {
              href: detail.href
            };
  ...
  ContentTools.Tools.AlignLeft = (function(_super) {
    ...
    ContentTools.ToolShelf.stow(AlignLeft, 'alignleft');
  ...
  ContentTools.Tools.AlignRight = (function(_super) {
    ...
    ContentTools.ToolShelf.stow(AlignRight, 'alignright');
